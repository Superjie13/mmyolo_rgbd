...
#########################################################################
partition_flag = True  # if you want export part of the model, set to True, otherwise set to False to export the end2end model
end_flag = 'yolo_head'  # output the cls_score, bbox_pred and objectness at three different scales
# end_flag = 'yolo_head_raw'  # output the raw cls_score, bbox_pred before nms
#########################################################################
    ...
    partition_config = dict(
        ...
        partition_cfg=[
            dict(
                ...
                end=[f'{end_flag}:input'],  # get scores and bboxes before nms
