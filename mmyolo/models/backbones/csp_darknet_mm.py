...
Author: Sijie Hu
Date: 18/03/2024
Description: This script adapted from mmyolo.csp_darknet.py so as to build a CSPDarknet backbone for multimodal inputs.
"""
...
class YOLOXCSPDarknet_MM(BaseBackbone):
    """CSP-Darknet backbone used in YOLOX (two branches)"""
    ...
    def forward(self, x1: Tensor, x2: Tensor) -> tuple:
